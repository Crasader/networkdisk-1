...
public class RegisterTransaction {
	...
	public static User register(User user,long initSize) {
		...
		try {
			...
			String ob = runner.query(conn, "select LAST_INSERT_ID()", new ScalarHandler<Object>())+"";
			uID = Long.parseLong(ob);
			...
			homeID = Long.parseLong(runner.query(conn, "select LAST_INSERT_ID()", new ScalarHandler<Object>()).toString());
